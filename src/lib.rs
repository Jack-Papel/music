...
#![warn(
    missing_docs, clippy::missing_errors_doc, clippy::missing_panics_doc, clippy::missing_safety_doc, 
    clippy::doc_comment_double_space_linebreaks, clippy::doc_include_without_cfg, clippy::doc_link_code, 
    clippy::doc_link_with_quotes, clippy::doc_markdown, clippy::too_long_first_doc_paragraph, 
